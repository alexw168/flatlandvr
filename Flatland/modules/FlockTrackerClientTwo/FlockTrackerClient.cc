...
Copyright (C) 2000  The University of New Mexico
*/
...
void predictedCoeff(OBJECT_TYPE *TrackerClientObject) {
  ...
  float x_beta[MAX_NUMBER_OF_TRANSDUCERS][3];
  float y_beta[MAX_NUMBER_OF_TRANSDUCERS][3];
  float z_beta[MAX_NUMBER_OF_TRANSDUCERS][3];
  float ro_beta[MAX_NUMBER_OF_TRANSDUCERS][3];
  float ph_beta[MAX_NUMBER_OF_TRANSDUCERS][3];
  float yw_beta[MAX_NUMBER_OF_TRANSDUCERS][3];

  float	stored_x[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];
  float stored_y[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];
  float stored_z[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];

  float stored_ro[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];
  float stored_ph[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];
  float stored_yw[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];

  float raw_stored_ro[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];
  float raw_stored_ph[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];
  float raw_stored_yw[MAX_NUMBER_OF_TRANSDUCERS * MAXQUEUE];
  //  float alpha = 1.0;
  int currentFront = 0;
